<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div class="mt-2">
          ...
          <button
            ...
            :class="{ 'font-bold': currentLocale === 'fr' }"
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <!-- All available pages -->
      <div v-if="allPages && allPages.length > 0" class="bg-white rounded-lg shadow-lg p-6">
...
useHead({
  title: 'Nuxt CMS POC',
  meta: [
    { name: 'description', content: 'A proof of concept using Nuxt 3 and Decap CMS' },
...
const switchLocale = async (locale) => {
  ...
  // Refresh content for new locale
  await refreshCookie('nuxt-i18n', locale)
